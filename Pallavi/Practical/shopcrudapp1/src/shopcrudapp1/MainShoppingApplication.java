...
class FileUtil 
{
	...
	public static void getItembyCode(int code) throws ClassNotFoundException, IOException 
	{
...
class MainShoppingApplication 
{
	public static void main(String[] args) throws NumberFormatException 
	{
		try 
		{
			...
			while (running) 
			{
				System.out.println("Choose an operation: create , read , update , delete ,sell, exit ");
