...
class ResultFrame extends JFrame implements ActionListener
{
	...
	ResultFrame(String ttl)
	{
		...
		try
		{
			img=ImageIO.read(new File("C:\\Users\\vishw\\eclipse-workspace\\aptitudeproject\\img\\WATING.gif"));
	...
	public void actionPerformed(ActionEvent e)
	{
		if(e.getSource()==re)
		{
			...
			if(MainWindow.getMark()>=5) 
			{
				...
				try
				{
					imgpan.setImage(ImageIO.read(new File("C:\\Users\\vishw\\eclipse-workspace\\aptitudeproject\\img\\PASS.bmp")));	
				}
				catch (Exception ae)
				{
					ae.printStackTrace();
			...
			{				
				try
				{
					imgpan.setImage(ImageIO.read(new File("C:\\Users\\vishw\\eclipse-workspace\\aptitudeproject\\img\\FAIL.bmp")));	
				}
				catch (Exception ae)
				{
					ae.printStackTrace();
