...
class QuestionFillGUI extends JFrame implements ActionListener,FocusListener
{
	...
	JLabel lque;TextArea tque;
	JLabel lans;JTextField tans;
	JLabel lop1;JTextField top1;
	JLabel lop2;JTextField top2;
	JLabel lop3;JTextField top3;
	JLabel lop4;JTextField top4;
	...
	public void actionPerformed(ActionEvent e)
	{
		if(e.getSource()==ins)
		{
			...
			{
				qf.storeQuestion(Integer.parseInt(tid.getText().trim()),tque.getText().trim(),top1.getText().trim(),top2.getText().trim(),top3.getText().trim(),top4.getText().trim(),tans.getText().trim());
				status.setText("Inserted Successfully..");
				tid.setText("");
				tque.setText("");
				top1.setText("");top2.setText("");top3.setText("");top4.setText("");
				tans.setText("");
			}
			else JOptionPane.showMessageDialog(null,"Enter Only "+qf.getNextID()+" As ID");
		}
		if(e.getSource()==dis)
		{
			DatabaseInterface di=new DatabaseInterface();
			Question q=di.getFullQuestion(Integer.parseInt(tid.getText().trim()));
			tid.setText(""+q.getId());
		...
		{
			QuestionFill qf=new QuestionFill();
			qf.updateQuestion(Integer.parseInt(tid.getText().trim()),tque.getText().trim(),top1.getText().trim(),top2.getText().trim(),top3.getText().trim(),top4.getText().trim(),tans.getText().trim());
		}
	}
