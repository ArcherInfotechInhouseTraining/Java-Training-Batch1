...
//------------------------------------------------------------------------------------------------------------
	...
	// Differences Between C and Java
		...
		https://www.interviewbit.com/blog/difference-between-chrc-and-java/
...
//-------------------------------------------------------------------------------------------------------------
	...
	Line 5:  System.out.print("Welcome to Java");
			...
			out is predefined object of PrintStream class, declareed as a static in System class
...
//=================================================================================================
	...
	Note carefully that, Array gains the dynamic memory space, and for the allocation we
...
//------------------------------------------------------------------------------------------
	...
	// The element count can be dynamic, then lets see how the memory is allocated
...
//---------------------------------------------------------------------------------
	...
	In the java mutithreading, we can divide the entire work in two different steps, first is defining a task and second
	the thread management which includes thread creation, pooling, and lifecycle management etc.

	The task being done by a new thread, as defined by its Runnable object, and the thread itself, as defined by a 
	Thread object. This works well for small applications, but in large-scale applications, it makes sense to separate 
	thread management and creation from the rest of the application. Objects that encapsulate these facilities are 
	known as executors.
...
//-------------------------------
CompletableFuture is an enhancement to the Future concept, introduced in Java 8. It allows you to create more complex asynchronous workflows, making it easier to chain multiple asynchronous tasks.
